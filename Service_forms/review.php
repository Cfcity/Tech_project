...
<table class="review-table">
    <tr>
        <td colspan="8" style="font-size:1.3rem; font-weight:600;">
            Query Information
        </td>
    </tr>
    <tr>
        <td colspan="8" style="text-align: center;">
            <a href="../home_pages/home_admin.php">Home</a>
        </td>
    </tr>
    <?php
    ...
    if ($result && $row = mysqli_fetch_assoc($result)) {
        ...
        if (!empty($row['Reply_ID'])) {
            ...
            echo "<td colspan='2'>";
            if ($edit_mode) {
                echo "<textarea name='edit_reply_text' style='width:100%;' required>" . htmlspecialchars($row['reply']) . "</textarea>";
            } else {
                echo "<textarea readonly style='width:100%;'>" . htmlspecialchars($row['reply']) . "</textarea>";
            }
            echo "</td>";
