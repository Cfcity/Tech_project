                ...
                <div class="dashboard-cards" style="display: flex; flex-wrap: wrap; gap: 2rem; justify-content: center; margin-bottom: 2rem;">
                    ...
                    <div class="content-card" style="min-width: 320px; flex: 1 1 40%;">
                        ...
                        <div class="center-text" style="margin-top: 1rem;">
                            ...
                            ?>
                            <span style="color: #2a7ae4;">Pending: <?= $pending ?></span> |
                            <span style="color: #e43a2a;">Unread: <?= $unread ?></span> |
        ...
        <div id="services" class="tabcontent">
            <div class="content-card">
                ...
                <div style="display: flex; justify-content: center; gap: 1rem; margin-bottom: 1rem;">
                    <form action="" method="post">
                        <input class="primary-button" style="width: 105%;" type="submit" name="add_service" value="Add New Service">
                    </form>
                    <form action="" method="post">
                        <input class="primary-button" style="width: 100%;" type="submit" name="delete_service" value="Manage Services">
                    </form>
                </div>
